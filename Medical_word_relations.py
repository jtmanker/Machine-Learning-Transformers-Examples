...
Original file is located at
    https://colab.research.google.com/drive/1Iu9K--dJVhHoXDgZbxlZyzBMHYjChxvG
"""
...
class DataExtractor():
  ...
  def get_training_data(self):
    ...
    for ann_file in ann_files:
      pair_relations = self.extract_ann_data(ann_file)
    ...
    for pair in pairs:
      ...
      for ev_text in event_text:
        if set(pair).issubset(ev_text):  #checks to see the relation is attested somewhere in the E lines
          relation = "RELATED"
      pair_relations.append((pair, relation))
  ...
  def get_pairs(self, entities_temp, atts_temp):
    pairs = set((ent.split('\t')[2], att.split('\t')[2]) for ent in entities_temp for att in atts_temp)
    return pairs
